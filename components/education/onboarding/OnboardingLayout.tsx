...
export default function OnboardingLayout() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-6rem)] overflow-hidden rounded-4xl bg-slate-50/50">
      ...
      <div className="flex h-full p-6 gap-6">
        ...
        <div className="flex-1 relative flex flex-col bg-white/40 backdrop-blur-xl border border-white/20 shadow-2xl shadow-blue-900/5 rounded-4xl overflow-hidden transition-all duration-300">
           ...
           <div className="h-20 flex items-center justify-between px-8 border-b border-white/10 bg-white/20 backdrop-blur-md z-10">
              ...
              <div className="flex items-center gap-3 bg-white/30 border border-white/20 px-4 py-1.5 rounded-full backdrop-blur-md">
                 <span className="text-xs font-bold text-navy-700">Paso {currentStep}</span>
           ...
           <div className="flex-1 overflow-hidden relative">
               <ChatInterface onStepChange={setCurrentStep} currentStep={currentStep} />
           </div>
        </div>
