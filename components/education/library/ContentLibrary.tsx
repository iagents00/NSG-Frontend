        ...
        <div className="flex flex-col h-full gap-8 p-6">
            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between">
                     <h1 className="text-3xl font-display font-bold text-navy-900 tracking-tight">Biblioteca de Conocimiento</h1>
                     ...
                     <div className="flex items-center gap-3">
                        <div className="relative group">
                            ...
                            <input 
                                ...
                                className="pl-9 pr-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all w-64"
                            />
                        </div>
