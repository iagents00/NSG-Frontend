        ...
        <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
            ...
            >
                ...
                <div className="pt-6 flex flex-col items-center gap-3">
                    <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-blue-600 bg-blue-50/50 px-4 py-2 rounded-full border border-blue-100/50 font-display">
