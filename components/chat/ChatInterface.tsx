                ...
                try {
                    ...
                    if (parsed.answer) {
                        if (typeof parsed.answer === "string") {
                            // Pulse Mode (Single String) or Fusion (Single String)
                            displayContent = parsed.answer;
                        } else if (typeof parsed.answer === "object") {
                            // Compare Mode (Object with keys) OR Pulse (Object with keys)
                            const answers = parsed.answer;
                            
                            // Map UI selectedModel to keys
                            if (selectedModel === "NSG AI" && answers.nsgai) {
                                displayContent = answers.nsgai;
                            } else if (selectedModel === "Chat GPT" && answers.openai) {
                                displayContent = answers.openai;
                            } else if (selectedModel === "Gemini" && answers.gemini) {
                                displayContent = answers.gemini;
                            } else if (selectedModel === "Claude" && answers.claude) {
                                displayContent = answers.claude;
                            } 
                            // Fallbacks if specific key is missing but others exist
                            else if (answers.nsgai) displayContent = answers.nsgai;
                            else if (answers.openai) displayContent = answers.openai;
                            else if (answers.claude) displayContent = answers.claude;
                            else if (answers.gemini) displayContent = answers.gemini;
                            else {
                                isComingSoon = true;
                                displayContent = ""; 
                            }
