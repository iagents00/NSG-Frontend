        ...
        if (msg.role === "assistant") {
            ...
            if (
                ...
                try {
                    ...
                    else if (parsed.openai || parsed.openAI_response)
                        displayContent =
                            parsed.openai || parsed.openAI_response;
                    else if (parsed.gemini || parsed.gemini_response)
                        displayContent =
                            parsed.gemini || parsed.gemini_response;
                    else if (parsed.claude || parsed.claude_response)
                        displayContent =
                            parsed.claude || parsed.claude_response;
                } catch (e) {
...
export default function ChatInterface() {
    ...
    const messages = React.useMemo(() => {
        ...
        return rawMessages.filter(
            (m) =>
                m.targetModel === intelligenceMode ||
                (!m.targetModel && intelligenceMode === "compare"),
        );
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        try {
            ...
            const field =
                fieldMap[activeMode] || activeMode.replace("nsg_", "");
