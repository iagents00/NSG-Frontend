...
export default function TopNav() {
  ...
  return (
    <header className="h-16 lg:h-20 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 flex items-center justify-between px-3 sm:px-6 lg:px-10 sticky top-0 z-40 shrink-0 shadow-sm transition-all duration-300">
      ...
      <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 shrink-0">
        ...
        >
          <div className="w-4 h-4 sm:w-5 h-5 relative shrink-0 atom-container">
